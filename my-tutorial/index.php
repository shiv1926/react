...
<ul class="index">
	...
	<li>
		...
		<ul>
			...
			<li><a href="deployment-react-app.php">How to include google fonts</a></li>
			<li><a href="deployment-react-app.php">How to include otf/ttf fonts</a></li>
			<li><a href="deployment-react-app.php">CSS-IN-JS</a></li>
		</ul>
	</li>
	<li>
	...
	<li>
		...
		<ul>
			...
			<li><a href="pure-component.php">Pure Components</a></li>
			<li><a href="https://blog.bitsrc.io/6-reasons-to-use-react-hooks-instead-of-classes-7e3ee745fe04">Reasons to use hooks instead of class</a></li>
	...
	<li>
		...
		<ul>
			...
			<li><a href="hooks-useeffect.php">useEffect Hook</a></li>
			<li><a href="create-context.php">Create Context</a></li>
			<li><a href="hooks-usecontext.php">useContext Hook</a></li>
			<li><a href="custom-hooks.php">Custom Hook</a></li>
		</ul>
	</li>
	<li>
		...
		<ul>
			...
			<li><a href="react-router-dom.php">React Router DOM</a></li>
			<li><a href="useparams.php">UseParams</a></li>
			<li><a href="uselocation.php">UseLocation</a></li>
		</ul>
	</li>
	<li>
		...
		<ul>
			...
			<li><a href="axios.php">Axios</a></li>
		</ul>
	</li>
	<li>
	...
	<li>
		...
		<ul>
			...
			<li><a href="rest-api-get-method.php">Rest API GET method</a></li>
			<li><a href="rest-api-post-method.php">Rest API POST method</a></li>
			<li>https://www.smashingmagazine.com/2018/03/react-wordpress-web-app/</li>
		</ul>
	</li>
	<li>
		<strong>Redux</strong>
